								...
								<tbody>
									...
									<tr>
										...
										<td style="width:155px;" class="item">
											<input type="text" style="width:155px;" id="filter_title" value="<?php echo $this->input->get('title')?>" name="title">
										</td>
			...
			<tbody class="list_item">
				...
				<tr class="row_<?php echo $row->id?>">
					...
					<td class="option textC">
						...
						<a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('news/delete/'.$row->id)?>">
