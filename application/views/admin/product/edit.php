			...
			<div class="widget">
				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							<label class="formLeft">Hình ảnh cua manh hung :
								<span class="req">*</span>
							</label>
							<div class="formRight">
								<div class="left">
                                    ...
                                    <img src="<?php echo base_url('upload/product/'.$product->image_link); ?>" style="width: 100px;">
								</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left">
									<input type="file" multiple="" name="image_list[]" id="image_list" size="25"></br>
									<?php if(is_array($image_list)): ?>
                                    <?php foreach($image_list as $img): ?>
                                    <img src="<?php echo base_url('upload/product/'.$img); ?>" style="width: 100px; magrin:5px;">
									<?php endforeach; ?>
									<?php endif; ?>
								</div>
