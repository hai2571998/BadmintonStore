...
<div class="usual" id="usual1">
	<ul>
		<li>
			<a title="Chi tiết sản phẩm" rel='tab2' href='javascript:void(0)' class="tab selected">Chi tiết sản phẩm</a>
		</li>
		<!-- <li>
			<a title="Video" rel='tab3' href='javascript:void(0)' class="tab">Video</a>
		</li> -->
		<li>
			<a title="Hỏi đáp về sản phẩm" rel='tab4' href='javascript:void(0)' class="tab">Hỏi đáp về sản phẩm</a>
		</li>
	</ul>
</div>
...
<div class="usual-content">
	<div id="tab2" style="display: block;">
		...
		<center>
			...
			<div class="fb-comments" data-href="<?php echo current_url(); ?>" data-num-posts="5" data-width="550"
					...
					<tbody>
						<tr>
							<td style='width:210px;padding-right:15px;vertical-align:top'>
								...
								<img id="imgsecuri" src="http://localhost/webphp/captcha/three.html" style="margin-bottom: -6px;" _captcha="http://localhost/webphp/captcha/three.html"
								class="imgrefresh">
...
<div class="box-center">
	...
	<div class="box-content-center product">
		...
		<div class='product_item'>
			...
			<p class='price'>
				3,800,000 1294-14 đ
				<span class='price_old'>4,000,000 124đ</span>
			</p>
			<center>
