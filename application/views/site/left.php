...
<div class="box-left">
	...
	<div class="content-box">
		...
		<form class="t-form form_action" method="get" style="padding:10px" action="<?php echo site_url('product/search_price');?>" name="search">
			...
			<div class="form-row">
				<label for="param_price_from" class="form-label" style="width:70px">Giá từ:
					<span class="req">*</span>
				</label>
				<div class="form-item" style="width:90px">
					<select class="input" id="price_from" name="price_from">
						<?php for($i=0; $i <= 10000000; $i+=500000): ?>
			...
			<div class="form-row">
				<label for="param_price_from" class="form-label" style="width:70px">Giá tới:
					<span class="req">*</span>
				</label>
				<div class="form-item" style="width:90px">
					<select class="input" id="price_to" name="price_to">
						<?php for($i=100000; $i <= 10000000; $i+=100000): ?>
...
<div class="box-left">
	...
	<div class="content-box">
		...
		<ul class="catalog-main">
			...
			<li>
				<span>
					<a href="<?php echo base_url('/product/catalog/'.$row->id); ?>" title="<?php echo $row->name; ?>"><?php echo $row->name; ?></a>
				</span>
