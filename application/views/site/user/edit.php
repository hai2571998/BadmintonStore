	...
	<div class="box-content-center register">
		...
		<form enctype="multipart/form-data" action="<?php echo site_url('user/register'); ?>" method="post" class="t-form form_action">
			<div class="form-row">
				...
				<div class="form-item">
					<input type="email" value="<?php echo $user->email; ?>" name="email" id="email" class="input" readonly>
					<div class="clear"></div>
			...
			<div class="form-row">
				<label class="form-label" for="param_re_password">Gõ lại mật khẩu:
					<span class="req">*</span>
				</label>
				<div class="form-item">
			...
			<div class="form-row">
				<label class="form-label" for="param_address">Địa chỉ:
					<span class="req">*</span>
				</label>
				<div class="form-item">
